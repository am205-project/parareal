...
#SBATCH -o algo512_8x8procs.out    #File to which standard out will be written
#SBATCH -e algo512_8x8procs.err    #File to which standard err will be written

# load modules
module load centos6/mpi4py-1.3.1_python-2.7.3_openmpi-1.6.4_gcc-4.8.0
module load centos6/numpy-1.7.1_python-2.7.3

mpirun -n 64 python parallel_wave512.py 8 8
