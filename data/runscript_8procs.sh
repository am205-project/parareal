...
#SBATCH -o algo_8procs.out    #File to which standard out will be written
#SBATCH -e algo_8procs.err    #File to which standard err will be written
...
for q in 100 
do
    mpirun -n 8 python ../pararealAlgo.py --nsteps 100 --quality-factor $q --correction-level $k
done
