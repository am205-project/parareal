...
\begin{equation}
\textnormal{Eff}_{\textnormal{strong}} = \frac{T(1)}{n \cdot T(n)} \cdot 100\%
\end{equation}
...
Because this task is embarassingly parallel and nearly 100% of the computation code can be parallelized (disregarding any uneven divisions of the space by the number of processors), we achieve the Amdahl's Law optimal speedup bound (with $B$ of 1):
